# Rally/ResearchAlly Developer Tools
...
## the Rally with Mass General Brigham Projects web component

There are three steps to including the Rally Projects web component on your page:
...
3.  Add the Rally with Mass General Brigham Projects web component to your web page
...
The following example displays searches Rally for projects which reference the keyword `diabetes`:
